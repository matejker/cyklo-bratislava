    ...
    return (
        <>
            ...
            <p>
                ...
                I would add the most important links to the existing network, i.e. the ones with the highest betweenness centrality.
            </p>

            <div className="center">
                <img src={edge_betweeness_cyclo_paths} style={{width: '1000px', marginLeft: '-150px'}} />
                <div style={{textAlign: 'justify'}}>
                <span className="image-desc">
                    Blue - existing cycle paths, orange - new edges with high betweenness centrality.
                </span>
                </div>
            </div>
            ...
            <div className="center">
                <img src={l2c_betweenness_existing} style={{width: '1000px', marginLeft: '-150px'}} />
                <div style={{textAlign: 'justify'}}>
                <span className="image-desc">
                    Blue - existing cycle paths, orange - new edges with high betweenness centrality.
                </span>
            ...
            <p>
                ...
                its directness overcomes the average discreteness of cars in this area.
            </p>

            <div className="center">
                <img src={all_together} style={{width: '1000px', marginLeft: '-150px'}} />
                <div style={{textAlign: 'justify'}}>
                <span className="image-desc">
                    Blue - existing cycle paths, high betweenness and L2C links, red - newly connected endpoints.
                </span>
                </div>
            </div>
            ...
            <p>
                ...
                are doubling already existing infrastructure, and it is not clear how to prioritize the new links, even strategies
                proposed in previous chapter could be an inspiration.
            </p>
            <div className="center">
            ...
            <p>
                ...
                to calculate and demonstrate centrality, betweenness and directness. Last but not least, to describe
                some of the mobility patterns of cyclists in Bratislava.
            </p>
